...
public class ZoomingImages extends FrameLayout {
    ...
    public ZoomingImages(Context context) {
        this(context, null);
    }

    public ZoomingImages(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZoomingImages(Context context, AttributeSet attrs, int defStyle) {
